...
//}
	...
	for(int k=0; k<10; k++)
		...
		//arrWord[220] = 340; // Temp
		
		pmkError = arrWord[200]!= 0;
		
		//arrWord[221] = 512; // Temp
//		arrWord[50] = 0xFFFF; //Temp Test
...
//			ttr =0;
//		}			
//			if ((((arrWord[i]&0x00FF) == 0x0014) | (arrWord[i]== _mode20P) | (arrWord[i]== _mode30P))==0 )
//			{arrWord[i]= (arrWord[i] & 0xFF00)|_mode20P;}
//			if ((((arrWord[i]&0xFF00) == _mode10P<<8) | (arrWord[i]== _mode20P<<8) | (arrWord[i]== _mode30P<<8))==0 )
//			{arrWord[i]= (arrWord[i] & 0x00FF)|_mode20P<<8;}
//			
			...
			if (arrWord[i+40]>5)// нормирует режим канала
				{
				 arrWord[i+40] = 0;
				}
		}
